...
rm -rf device/xiaomi/fog && git clone https://gitlab.com/sourceslab062/device_xiaomi_fog.git --depth 1 -b 14-HorizonDroid device/xiaomi/fog
...
rm -rf build/soong && git clone https://github.com/DroidX-UI/build_soong.git --depth 1 -b 14 build/soong
